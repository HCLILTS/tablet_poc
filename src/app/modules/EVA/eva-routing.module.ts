...
import { Template15_Component } from './template15_/template15_.component';
...
const routes: Routes = [
  ...
  { path: 'evatemp13', component: Template13Component, runGuardsAndResolvers: 'always', data :{ TemplateType:'EVA'}},
  { path: 'evatemp13ext', component: Template13Component, runGuardsAndResolvers: 'always', data :{ TemplateType:'EVA'}},
  { path: 'evatemp15_', component: Template15_Component, runGuardsAndResolvers: 'always' , data :{ TemplateType:'EVA'}},
  { path: 'evatemp15_ext', component: Template15_Component, runGuardsAndResolvers: 'always', data :{ TemplateType:'EVA'}},
