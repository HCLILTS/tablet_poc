...
export class Template6Component implements OnInit ,OnDestroy,AfterViewChecked, AfterViewInit {
	...
	showRightAnswerPopup() {
		let showAnsPopup: HTMLElement = this.celebrationsPopup.nativeElement as HTMLElement;
		this.celebrationTimer = setTimeout(() => {
			if (this.multiCorrectFeedback && this.multiCorrectFeedback.nativeElement) {
				showAnsPopup.className = "modal d-flex align-items-center justify-content-center showit ansPopup dispFlex";
