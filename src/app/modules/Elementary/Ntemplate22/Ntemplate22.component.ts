...
import { HttphandlerService } from 'src/app/common/services/httphandler.service';

@Component({
  selector: 'Ntemplate22',
  templateUrl: './Ntemplate22.component.html',
  styleUrls: ['./Ntemplate22.component.scss']
})

export class Ntemplate22Component implements OnInit {
