...
@Component({
  ...
  styleUrls: ['./Ntemplate17.component.scss', "../../../../../node_modules/simple-keyboard/build/css/index.css"]
  //todo
})

export class Ntemplate17Component implements OnInit, OnDestroy {
  ...
  @ViewChild('submitModalRef',{static: true}) submitModalRef: any;
  @ViewChild('popupRef',{static: true}) popupRef: any;
  @ViewChild('confirmReplayRef',{static: true}) confirmReplayRef: any;
  @ViewChild('confirmSubmitRef',{static: true}) confirmSubmitRef: any;
  @ViewChild('mainVideo',{static: false}) mainVideo: any;
  @ViewChild('feedbackInfoAudio',{static: true}) feedbackInfoAudio: any;
  @ViewChild('quesContainer',{static: true}) quesContainer: any;
  @ViewChild('testContainer',{static: true}) testContainer: any;
  @ViewChild('wordBlockRef',{static: true}) wordBlockRef: any;
  @ViewChild('refques',{static: true}) refques: any;
  @ViewChild('optionPlaceRef',{static: true}) optionPlaceRef: any;
  ...
  @ViewChild('addBtnRef',{static: true}) addBtnRef: any;
  @ViewChild('inputDivRef',{static: true}) inputDivRef: any;
  // @ViewChild('simpleKeyboardRef') simpleKeyboardRef: any;
  @ViewChild('quesVORef',{static: true}) quesVORef: any;
  @ViewChild('instructionBar',{static: true}) instructionBar: any;
  @ViewChild('mathKeyboardRef',{static: false}) mathKeyboardRef: any;
