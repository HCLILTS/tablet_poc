...
@Component({
  selector: 'app-ntemplate20V1',
  templateUrl: './Ntemplate20_1.component.html',
  styleUrls: ['./Ntemplate20_1.component.scss'],
...
export class Ntemplate20V1Component implements OnInit, AfterViewChecked, OnDestroy {
...
resetBlinkImage(){
  ...
  fadeEverything() {
    ...
    this.renderer.setStyle(this.optionsBlock.nativeElement, 'opacity', '0.3');
